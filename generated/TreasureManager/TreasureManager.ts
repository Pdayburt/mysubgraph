...
export class TreasureManager extends ethereum.SmartContract {
  ...
  newMethod(): BigInt {
    let result = super.call("newMethod", "newMethod():(uint256)", []);

    return result[0].toBigInt();
  }

  try_newMethod(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("newMethod", "newMethod():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  userReward(param0: Address, param1: Address): BigInt {
    let result = super.call(
      "userReward",
      "userReward(address,address):(uint256)",
...
export class GrantRewardCall extends ethereum.Call {
  get inputs(): GrantRewardCall__Inputs {
    return new GrantRewardCall__Inputs(this);
  }

  get outputs(): GrantRewardCall__Outputs {
    return new GrantRewardCall__Outputs(this);
  }
}

export class GrantRewardCall__Inputs {
  _call: GrantRewardCall;

  constructor(call: GrantRewardCall) {
    this._call = call;
  }
...
export class GrantRewardCall__Outputs {
  _call: GrantRewardCall;
...
export class WithdrawERC20Call__Inputs {
  ...
  get _withdrawERC20Address(): Address {
    return this._call.inputValues[1].value.toAddress();
  }
...
export class WithdrawETHCall__Inputs {
  ...
  get _withdrawETHAddress(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
