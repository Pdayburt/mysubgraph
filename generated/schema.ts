...
export class DepositToken extends Entity {
  ...
  static loadInBlock(id: string): DepositToken | null {
    return changetype<DepositToken | null>(
      store.get_in_block("DepositToken", id),
    );
  }
...
export class WithdrawToken extends Entity {
  ...
  static loadInBlock(id: string): WithdrawToken | null {
    return changetype<WithdrawToken | null>(
      store.get_in_block("WithdrawToken", id),
    );
  }
...
export class GrantRewardTokenAmount extends Entity {
  ...
  static loadInBlock(id: string): GrantRewardTokenAmount | null {
    return changetype<GrantRewardTokenAmount | null>(
      store.get_in_block("GrantRewardTokenAmount", id),
    );
  }
...
export class WithdrawManagerUpdate extends Entity {
  ...
  static loadInBlock(id: string): WithdrawManagerUpdate | null {
    return changetype<WithdrawManagerUpdate | null>(
      store.get_in_block("WithdrawManagerUpdate", id),
    );
  }
